-- Expose the admin-controlled printables shipping status on the pipeline board.
    ...
    'jobs', (
      ...
      from (
        select bj.id                    as job_id,
               ...
               bj.copies_to_print,
               bj.due_date,
               bj.printables_shipped,
               bj.printables_shipping_updated_at,
               bj.printables_shipping_updated_by,
               bj.is_per_grade,
               bj.ocr_status,
